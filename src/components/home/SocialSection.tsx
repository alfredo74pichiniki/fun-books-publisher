...
export function SocialSection() {
    ...
    return (
        <section ref={sectionRef} className="py-20 sm:py-28 bg-navy-900">
            <div className="social-content max-w-3xl mx-auto px-6 text-center">
                ...
                <div className="flex gap-4 justify-center mb-12">
                    {SOCIAL_LINKS.map((social) => (
                        <a
                            ...
                            className={`w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white/50 hover:text-white hover:border-transparent transition-all hover:scale-110 hover:shadow-lg ${social.hoverBg}`}
                        >
